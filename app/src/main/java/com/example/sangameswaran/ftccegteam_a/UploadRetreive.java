...
public class UploadRetreive extends AppCompatActivity implements View.OnClickListener {
    ...
    public UploadRetreive() {
    }

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.upload_retreive);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.buttonChoose) {
            showFileChooser();
        } else if (id == R.id.buttonUpload) {
            uploadFile();
        } else if ((id == R.id.textViewShow))
        {
